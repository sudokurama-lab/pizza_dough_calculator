  ...
  <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
    ...
    <div class="mb-6">
      ...
      <div
        ...
        class="mt-3 text-sm text-orange-800 bg-orange-100 p-3 rounded-lg border border-orange-200 flex items-start"
      >
        <span class="mr-2">💡</span>
        <p>
          Esta masa te rendirá para aproximadamente
          <strong>{{ formatWeight(estimatedPizzas) }} pizzas</strong> de {{ weightPerPizza }}g cada
          una.
        </p>
      </div>
    </div>
    ...
    <div v-if="preferment" class="mb-6">
      ...
      <ul class="space-y-2 text-gray-600 bg-blue-50 p-4 rounded-xl border border-blue-100">
        ...
        <li
          class="flex justify-between items-center font-bold border-t border-blue-200 pt-2 mt-2 text-blue-800"
        >
    ...
    <div>
      ...
      <ul class="space-y-2 text-gray-600 bg-green-50 p-4 rounded-xl border border-green-100">
        ...
        <li
          v-if="preferment"
          class="flex justify-between items-center text-blue-700 font-bold pt-3 border-t border-green-200 mt-2 bg-blue-50/50 p-2 rounded-lg -mx-2"
        >
